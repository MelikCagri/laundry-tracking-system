...
- [x] **Erken Bitirme Opsiyonu:** Çamaşırı makinede belirtilen süreden önce biten kullanıcılar için "Çamaşırlarımı Aldım / Erken Bitir" butonu eklenecek. Bu sayede makine sistemde daha hızlı "BİTTİ" veya "BOŞ" durumuna geçebilecek.
