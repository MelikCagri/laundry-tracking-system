import { PrismaClient, MachineType, MachineStatus, Block } from '../backend/node_modules/@prisma/client/index.js';
...
async function main() {
  console.log('🚀 Starting database seed from execution/seed.ts...\n');
